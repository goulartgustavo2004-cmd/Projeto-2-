...
ax.set_xscale('log')
ax.set_yscale('log')
ax.loglog(h_list, enorm, 'bo-', linewidth=2, markersize=8, label='Erro em norma de energia')

ax.set_xlabel('Comprimento do elemento (h)', fontsize=12, fontweight='bold')
ax.set_ylabel('Erro em norma de energia', fontsize=12, fontweight='bold')
ax.set_title('Convergência: Erro vs Comprimento do Elemento (log-log)', fontsize=13, fontweight='bold')
